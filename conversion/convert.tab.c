...
{
  "\"end of file\"", "error", "\"invalid token\"", "BINARY", "DECIMAL",
  "HEX", "B2D", "D2B", "H2B", "B2H", "INVALID", "$accept", "input", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: B2D BINARY  */
#line 25 "convert.y"
                   { printf("Decimal: %d\n", binaryToDecimal((yyvsp[0].str))); }
#line 1072 "convert.tab.c"
    break;

  case 3: /* input: D2B DECIMAL  */
#line 26 "convert.y"
                   { printf("Binary: %s\n", decimalToBinary(atoi((yyvsp[0].str)))); }
#line 1078 "convert.tab.c"
    break;

  case 4: /* input: H2B HEX  */
#line 27 "convert.y"
                   { printf("Binary: %s\n", hexToBinary((yyvsp[0].str))); }
#line 1084 "convert.tab.c"
    break;

  case 5: /* input: B2H BINARY  */
#line 28 "convert.y"
                   { printf("Hex: %s\n", binaryToHex((yyvsp[0].str))); }
#line 1090 "convert.tab.c"
    break;


#line 1094 "convert.tab.c"
